...
import worker from "D:\\medium backend\\medium-backend\\backend\\.wrangler\\tmp\\bundle-wrlAka\\middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "D:\\medium backend\\medium-backend\\backend\\node_modules\\wrangler\\templates\\middleware\\common.ts";

// We need to preserve all of the exports from the worker
export * from "D:\\medium backend\\medium-backend\\backend\\.wrangler\\tmp\\bundle-wrlAka\\middleware-insertion-facade.js";
